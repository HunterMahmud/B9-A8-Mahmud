...
const ListedBooks = () => {
  ...
  let localData = [];
  // const loadDataAccordingToCurrentTab = ()=> {

  //   if(currentTab === 0){
  //     localData = getDataFromLocalStorage('read');
  //     console.log("readlish",localData);
  //   }else if(currentTab === 1){
  //     localData = getDataFromLocalStorage('wishlist');
  //     console.log("wishlist", localData)
  //   }
  // }
  // loadDataAccordingToCurrentTab();
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mx-auto flex justify-center my-5">
        <select
          className="bg-[#23BE0A] border-none p-3 rounded-2xl text-white mx-auto font-bold"
          name="books"
          id="books"
        >
          <option value="1">The Martian</option>
          <option value="2">Pride and Prejudice</option>
